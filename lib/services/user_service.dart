...
//----check here ----------
  ...
  static Future updateUser(TheUsers theUsers) async{
    try {
      final http.Response response = await http.put(
          Uri.parse(ServerConfig.domainName + ServerConfig.updateUser + '${theUsers.id}' ),
          body: json.encode({
            "first_name": theUsers.firstName,
            "last_name": theUsers.lastName,
            "email": theUsers.email,
            "employee_identical": theUsers.employeeIdentical,
            "password": "123456789",
            "role_id": theUsers.roleId == 3 ? 2 : 3,
            "team_id":theUsers.teamId
          }),
          headers: {
           "content-type": "application/json",
            "Accept": "application/json",
